...
sys.path.append(os.path.dirname(os.path.abspath(os.path.dirname(__file__))) + "CLRNet_research")
...
def main():
    ...
    cfg.load_from = r'C:\Users\H_\Desktop\LaneDetection\CLRNet_research\clrnet_resnet34_tusimple_70.pth' # pt파일 경로
